...
app.use('/api', require('./routes/registro_usuario.routes'));
app.use('/api', require('./routes/registro_artista.routes'));
app.use('/api', require('./routes/registro_album.routes'));
app.use('/api', require('./routes/listar_artista.routes'));
app.use('/api', require('./routes/registro_cancion.routes'));
